...
# START: https://github.com/floydhub/language-identification-template/blob/master/language-identification.ipynb
...
if __name__ == '__main__':
    ...
    del train_test_data
# END: https://github.com/floydhub/language-identification-template/blob/master/language-identification.ipynb

    # Computing
    for metric in ['silhouette', 'landscape', 'heat']:
        distances_all = list()
